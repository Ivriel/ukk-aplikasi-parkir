<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input disabled id="status_aktif" name="status_aktif" type="text" class="mt-1 block w-full"
                :value="old('status_aktif', $user->status_aktif)" required autofocus autocomplete="status_aktif" />
