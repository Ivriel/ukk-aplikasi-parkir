        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 dark:text-white">Daftar Tarif</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Kelola tarif di sini.
                        </p>
                    </div>
                    ...
                    <table class="w-full text-sm text-left">
                        <thead
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-4 font-bold">Tarif Per Jam</th>
                            ...
                            @forelse ($tarifs as $tarif)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 text-gray-500 dark:text-gray-400">
                                        <span class="text-xs block">{{ $tarif->updated_at->format('d M Y H:i') }}</span>
                                        <span
                                            class="text-[10px] text-gray-400">{{ $tarif->updated_at->diffForHumans() }}</span>
                                    </td>
                                    <td class="px-6 py-4 text-right space-x-3">
                                        ...
                                        <form action="{{ route('tarifs.destroy', $tarif->id) }}" method="POST"
                                            ...
                                            <button type="submit"
                                                ...
                                                onclick="return confirm('Yakin hapus data tarif {{ $tarif->jenis_kendaraan }}?')">
                                                Hapus
                                            </button>
                                        </form>
                                    </td>
